  ...
  dayPlan.work.forEach((ex, exIndex) => {
    ...
    if (removeBtn) {
      removeBtn.addEventListener('click', (e) => {
        ...
        const modalContent = tempModal.firstElementChild;
        
        // Show modal
        openModal('Exercise Options', '', modalContent.innerHTML);
        ...
        // Move to another day
        modalEl.querySelector('[data-action="move"]')?.addEventListener('click', () => {
          const wk = state.currentBlock?.weeks?.[weekIndex];
