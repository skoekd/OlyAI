...
function renderSetup() {
  ...
  // reflect selected schedule days in UI
  syncDaySelectorUI();
}
...
function bindDaySelectorHandlers(){
  ...
  // Prevent duplicate event binding across renders/nav
  if (daySelectorBound) { syncDaySelectorUI(); return; }
...
function boot() {
  ...
  // Bind schedule day selectors (multi-select, no overlap)
  bindDaySelectorHandlers();
